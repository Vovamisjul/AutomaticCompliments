...
# Зачем оборачивать весь код в try даже import и объявление функций
try:  # Обрабатываем все возможные ошибки
    ...
    # А если на сайте будет 5 страниц? Программа закроется?
    ...
    #Ввод имени можно вынести в отдельную функцию
    mask = re.compile(
